...
CREATE TABLE "Pinned" (
    ...
    CONSTRAINT "PK_Pinned" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "IX_ApiKey_organisationId" ON "ApiKey"("organisationId");
...
-- CreateIndex
CREATE INDEX "IX_Contact_organisationId" ON "Contact"("organisationId");
...
-- CreateIndex
CREATE INDEX "IX_Pinned_userId" ON "Pinned"("userId");

-- CreateIndex
CREATE INDEX "IX_Pinned_contactId" ON "Pinned"("contactId");

-- CreateIndex
CREATE INDEX "IX_Feedback_organisationId" ON "Feedback"("organisationId");

-- CreateIndex
CREATE INDEX "IX_Feedback_userId" ON "Feedback"("userId");

-- CreateIndex
CREATE INDEX "IX_Invitation_organisationId" ON "Invitation"("organisationId");
...
-- CreateIndex
CREATE INDEX "IX_Webhook_organisationId" ON "Webhook"("organisationId");

-- CreateIndex
CREATE INDEX "IX_WorkHours_organisationId" ON "WorkHours"("organisationId");
...
-- AddForeignKey
ALTER TABLE "Pinned" ADD CONSTRAINT "Pinned_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pinned" ADD CONSTRAINT "Pinned_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "Contact"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WorkHours" ADD CONSTRAINT "WorkHours_organisationId_fkey" FOREIGN KEY ("organisationId") REFERENCES "Organisation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
