...
import { EditInvitationModal } from '@/components/dashboard/settings/organisation/members/edit-invitation-modal';
import { RevokeInvitationModal } from '@/components/dashboard/settings/organisation/members/revoke-invitation-modal';
